...
insert into Terms(id, parent_id, name, description, weight) values('00000000-0000-0000-0000-000000000000', '9046bb3f-a560-47a5-9a9a-2fe8b076d91e', '親', 'システム予約設定値', 0);
...
insert into TermTrees(parent_id, id) values('00000000-0000-0000-0000-000000000000', 'd344d8f7-99c7-49b3-9ac5-8aef925c0192');
insert into TermTrees(parent_id, id) values('00000000-0000-0000-0000-000000000000', 'bb70eae3-5966-42cd-bc08-936ee47b4836');
insert into TermTrees(parent_id, id) values('d344d8f7-99c7-49b3-9ac5-8aef925c0192', 'a12ebe15-306c-4b25-8ca5-6f9b7cd27f2c');
insert into TermTrees(parent_id, id) values('d344d8f7-99c7-49b3-9ac5-8aef925c0192', 'd60ffd1e-dc09-48d2-8a29-152e92ae8a48');